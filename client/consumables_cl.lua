...
--<!>-- NOTIFICATIONS START --<!>--
RegisterNetEvent('qb-consumables:notify')
AddEventHandler('qb-consumables:notify', function(msg, type)
...
--<!>-- EVENTS START --<!>--
-- Consume food/drink
RegisterNetEvent('qb-consumables:cl:Consumables', function(itemremove, itemadd, meta, amount, stress, lang, timer, animd, anims, flag, prop, bones, coord, rotat)
...
RegisterNetEvent('qb-consumables:cl:ConsumablesSickness', function(itemremove, itemadd, meta, amount, stress, chance, lang, timer, animd, anims, flag, prop, bones, coord, rotat)
    ConsumablesSickness(itemremove, itemadd, meta, amount, stress, chance, lang, timer, animd, anims, flag, prop, bones, coord, rotat)
end)
-- Consume alcohol
RegisterNetEvent('qb-consumables:cl:ConsumablesAlcohol', function(itemremove, itemadd, meta, amount, stress, chance, lang, timer, animd, anims, flag, prop, bones, coord, rotat)
    ConsumablesAlcohol(itemremove, itemadd, meta, amount, stress, chance, lang, timer, animd, anims, flag, prop, bones, coord, rotat)
end)

-- Open 6 packs
RegisterNetEvent('qb-consumables:cl:Open6Pack', function(itemremove, itemadd, lang)
    TriggerServerEvent('qb-consumables:sv:RemoveItem', itemremove, 1)
    Wait(2*1000) -- 2 seconds
    TriggerServerEvent('qb-consumables:sv:AddItem', itemadd, 6) 
    TriggerEvent('qb-consumables:notify', lang, 'success')
end)
--<!>-- EVENTS END --<!>--
...
function Consumables(itemremove, itemadd, meta, amount, stress, lang, timer, animd, anims, flag, prop, bones, coord, rotat)
    Core.Functions.Progressbar('Elite_consumables', lang, timer*1000, false, true,{
        ...
        TriggerServerEvent('qb-consumables:sv:RemoveItem', itemremove, 1)
        TriggerServerEvent('qb-consumables:sv:AddItem', itemadd, 1)
        TriggerServerEvent('qb-consumables:sv:SetMeta', meta, amount)
        TriggerServerEvent(RemoveStress, stress)
    end, function() -- Cancel
        TriggerEvent('inventory:client:busy:status', false)
        TriggerEvent('qb-consumables:notify', Language.Shared['cancelled'], 'primary')
    end)
end
...
function ConsumablesSickness(itemremove, itemadd, meta, amount, stress, chance, lang, timer, animd, anims, flag, prop, bones, coord, rotat)
    Core.Functions.Progressbar('Elite_consumablesick', lang, timer*1000, false, true,{
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = false
        ...
        TriggerEvent('inventory:client:busy:status', false)
        TriggerEvent('qb-consumables:notify', 'Action Cancelled!', 'primary')
    end)
end
...
function FeelSick()
    ...
    Wait(2000) -- 2 seconds
    TriggerEvent('qb-consumables:notify', 'You feel sick..', 'primary')
    Wait(5000) -- 5 seconds
